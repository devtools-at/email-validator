...
<p align="center">
  <a href="https://devtools.at/tools/email-validator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Validate email addresses</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/email-validator">Try Online</a> •
...
**[Try Email Validator online at DevTools.at →](https://devtools.at/tools/email-validator)**
...
Validate email addresses. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/email-validator';
